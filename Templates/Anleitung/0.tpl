...
<h2>羅馬人</h2>
  <p>
    ...
    羅馬帝國可以說是最適合初學玩家的民族。擁有高度社會文明及發達科技的羅馬人是一個攻守俱佳的種族，但反之因為需要確保每一名士兵都有出色的攻防能力，羅馬部隊需要較多的資源及時間去訓練。換句話說，羅馬部隊的開發成本是三個種族中最高亦是最慢的。<br>
    羅馬擁有優秀的步兵，但步兵對敵方的騎兵防守力比另外兩個種族來得弱。<br>
...
<p>
  ...
  善於攻擊的條頓人擁有英勇無畏的精神，使他們成為最令人畏懼的部隊。<br><br>
  初級部隊開發成本較低而攻擊力不錯，使得其在游戲初期擁有一定優勢。<br><br>
