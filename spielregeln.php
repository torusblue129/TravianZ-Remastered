		...
		<li><strong style="color: #2A720B">§3 資源運輸</strong><br>
			<ul><li>玩家不得以輔助他人進行遊戲為目的註冊帳號。當遭到惡意的過度運輸時，資源運輸方將受到懲罰，而資源接受方不會受到懲罰，但需要向MH進行報備說明，如不報備將視為協議交收一同處分。除補充說明的情況外，遊戲守則將不限制且不檢查玩家間的過度運輸行為（Pushing）<br>
				<ul><li>Pushing 系統對玩家的限制方式取決於玩家間的帳號登入/連接遊戲方式（Connection Type，下稱 CT）來分類。<br><br></li>
					...
					<li>
						<ol>CT1 規則<br>
							<li>可以向高人口帳號運送2小時產量的資源（可預支7天）。<br>
							<li>可以向低人口帳號運送3小時產量的資源（可預支7天）。<br>
							<li>可以增援高人口帳號並且運送150%的糧食供給（可預支24小時所需的100%的資源），多出的50%只能是糧食供給（即一批運輸內糧 &gt; 泥+木+鐵 ）。<br>
							<li>可以增援低人口帳號並且運送300%的糧食供給（可預支24小時所需的100%的資源），多出的200%只能是糧食供給。<br>
							<li>可以無限量搶奪高人口帳號。<br> （如果處於同一聯盟，則適用上列第2條，即可搶奪3小時產量）<br>
							<li>可以無限量搶奪低人口帳號。<br> （如果處於同一聯盟，則適用上列第1條，即可搶奪2小時產量）<br>
							<li>可以征服村莊，但必須滿足：兩個帳號最近14天內無代管關係，並且最近二天內兩個帳號不處於同一聯盟或友好聯盟內。<br><br>
						</ol>
					</li>
					<li>
						<ol>CT2 規則<br>
							<li>可以向高人口帳號運送1小時產量的資源（可預支3天），但人口低於50時無法運送。<br>
							<li>可以向低人口帳號運送2小時產量的資源（可預支3天），但人口低於50時無法運送。<br>
							<li>可以增援高人口帳號並且運送125%的糧食供給（可預支12小時所需的100%的資源），多出的25%只能是糧食供給。<br>
							<li>可以增援低人口帳號並且運送150%的糧食供給（可預支12小時所需的100%的資源），多出的50%只能是糧食供給。<br>
							<li>可以無限量搶奪高人口帳號。<br> （如果處於同一聯盟，則適用上列第2條，即可搶奪2小時產量）<br>
							<li>搶奪低人口帳號時適用上列第1條，即可搶奪1小時產量。<br>
							<li>可以征服村莊，但必須滿足：兩個帳號最近14天內無代管關係，並且最近二天內兩個帳號不處於同一聯盟或友好聯盟內。<br><br>
					</li>
					<li>CT3 規則<br>
